 ...
 * 
 * This method calls on the method that updates the price and prive with VAT for
 * the sale and then checks if a matching item already exists in a arraylist, 
 * in which case it increases the quantity of attribute of the existing item.
 * If not, it instead adds the item to the list.
 * That is how the alternative flow 3-4b is handled.
...
/**
 * This a private method that updates price for a sale 
 * and the price with VAT included.
 */
...
* It needed to be package private for testing of the sale Class.
*/  
